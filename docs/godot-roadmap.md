...
| v0.6 | Feb 2026 | Species Diversity: 20 new biome-specific species (Fish, Shark, Frog, Turtle, Elk, Boar, Bear, Hawk, Lizard, Scorpion, Camel, Snake, Penguin, Polar Bear, Arctic Fox, Musk Ox, Monkey, Parrot, Jaguar, Tapir), omnivore diet type, flying movement flag, venom DOT mechanic, drowning/suffocation, weighted spawn budgets, 13 new shape types. Hunting System Refactoring: HuntingTactic enum (Solo/PackCoordinated/Swarm/Ambush), clean tactic-based dispatch, per-species tactic assignment, S-curve (smoothstep) AoE growth scaling, thorn defense system, species-specific terrain comfort in target selection, anti-target-fixation suppress timers |
