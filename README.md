...
- **Ecosystem simulation** — 28 species (8 core + 20 biome-specific) with hunger, energy, predator/prey dynamics, and faction warfare
...
├── Systems/                          # 19 simulation systems (20 TPS)
